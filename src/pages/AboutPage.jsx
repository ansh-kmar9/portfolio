...
const AboutPage = () => {
  ...
  // Scroll to top when pathname changes and no hash
  useEffect(() => {
    if (!location.hash) {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about my skills, experience, and education as a full-stack web developer."
        />
      </Helmet>
      ...
      <div className="fixed inset-y-0 left-0 z-20 w-64 bg-[#0A0A0A] border-r border-[#1E1E1E] p-6 transition-transform duration-200 ease-in-out hidden md:block">
        <div className="h-full flex flex-col">
          <div className="space-y-2 mt-10">
            <div className="text-xs uppercase text-white/40 font-medium tracking-wider mb-4">
              Navigation
            </div>
            <nav className="space-y-1">
              ...
              >
                ...
                >
                  <path
                    d="M7.5 1.5L15 5.5L7.5 9.5L0 5.5L7.5 1.5ZM7.5 10.5L0 6.5V11L7.5 15L15 11V6.5L7.5 10.5Z"
                    fill="currentColor"
                  />
                </svg>
                Education
              ...
              >
                <svg
                  ...
                  viewBox="0 0 15 15"
                  className={
                    activeSection === "skills" ? "text-white" : "text-white/60"
                  }
                >
                  <path
          ...
          <div className="mt-auto">
            <div className="rounded-md border border-[#1E1E1E] p-4 bg-[#121212]">
              ...
              <a
                href="/contact"
                className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-[#0A0A0A] hover:bg-white/90 h-8 px-3 py-2 w-full"
              >
                Contact Me
              </a>
            </div>
        ...
        <div className="max-w-[95%] md:max-w-6xl mx-auto">
          <div className="md:ml-64 p-2 sm:p-4">
            <div className="mb-8 md:mb-12">
              <div className="bg-[#0A0A0A] rounded-lg border border-[#1E1E1E] p-4 sm:p-5 md:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="space-y-1.5">
                    <p className="text-[11px] sm:text-xs uppercase tracking-wider text-white/50">
                      Personal
                    </p>
                    <h2 className="text-base sm:text-lg md:text-xl font-medium text-white/95">
                  ...
                  <Link
                    to="/about/personal"
                    className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-xs sm:text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-[#0A0A0A] hover:bg-white/90 h-9 sm:h-10 px-4 sm:px-5"
                  >
                    Click here to read
                  </Link>
                </div>
            ...
            <div
              id="coding-profiles"
              className="pt-2 md:pt-4 mb-14 md:mb-0 w-full"
            >
              <CodingProfiles />
            </div>
          </div>

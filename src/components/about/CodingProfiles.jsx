...
const StatsCard = ({ title, children, customClass = "" }) => (
  <div className={`bg-[#0A0A0A] border border-[#1E1E1E] rounded-md p-3 sm:p-4 ${customClass}`}>
      ...
      >
        <div className="space-y-4 sm:space-y-6">
          <div className="space-y-1">
            <h2 className="text-lg sm:text-xl font-medium text-white/95">Coding Profiles</h2>
            ...
            <StatsCard 
              title={
                <div className="flex items-center justify-between w-full">
                  ...
                  >
                    @{githubUsername} <FaExternalLinkAlt size={8} className="sm:text-[10px]" />
                  </a>
                </div>
              } 
            >
              <div className="w-full overflow-x-auto scrollbar-thin pb-2 sm:pb-3 -mx-2 px-2">
                <div className="min-w-[550px] sm:min-w-[650px] md:min-w-full">
                  <img 
                    ...
                    style={{ filter: "brightness(0.8) contrast(1.2) invert(0.1)" }}
                  />
              ...
              title={
                <div className="flex items-center justify-between w-full">
                  ...
                  <a 
                    ...
                    className="text-white/60 hover:text-white/90 text-[10px] sm:text-xs flex items-center gap-1 transition-colors"
                  >
                    @{leetcodeUsername} <FaExternalLinkAlt size={8} className="sm:text-[10px]" />
                  </a>
                </div>
              }
            >
          ...
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-xs sm:text-sm font-medium text-white/70">Other Platforms</h3>
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {[
                ...
                {
                  name: "Codolio",
                  href: `https://codolio.vercel.app/user/${codolioUsername}`,
                  img: "https://codolio.vercel.app/favicon.ico"
                }
              ].map((profile, index) => (
                <a
                  key={index}
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-md border border-[#1E1E1E] bg-[#121212] hover:bg-[#171717] transition-colors duration-200">
                    <img
                      src={profile.img}
                      alt={profile.name}
                      className={`h-4 w-4 sm:h-6 sm:w-6 object-contain ${profile.invert ? 'invert' : ''}`}
                    />
